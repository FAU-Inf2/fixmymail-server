...
run-dovecot:
	docker run -d -p 0.0.0.0:1025:25 -p 0.0.0.0:10587:587 -p 0.0.0.0:10143:143 -v /srv/vmail:/srv/vmail dovecot:2.1.7

run-courier:
	docker run -d -p 0.0.0.0:1125:25 -p 0.0.0.0:11587:587 -p 0.0.0.0:11143:143 -v /srv/vmail:/srv/vmail courier:0.73.1

run-cyrus:
	docker run -d -p 0.0.0.0:1225:25 -p 0.0.0.0:12587:587 -p 0.0.0.0:12143:143 -v /srv/vmail:/srv/vmail cyrus:2.4.17
